...
driver.get("https://news.naver.com/main/ranking/read.nhn?mid=etc&sid1=111&rankingType=popular_day&oid=079&aid=0003235555&date=20190606&type=1&rankingSeq=1&rankingSectionId=102")
...
while driver.find_element_by_xpath("//*[@id='cbox_module']/div/div[9]/a/span[1]"):
    driver.implicitly_wait(1)
    ## 댓글 더 보기 누르기
    try:
