...
train_X_ = W2V.Convert2Vec("./model/Word2vec.model",train_X)  ## import word2vec model where you have trained before
test_Y_ = W2V.One_hot(test_Y)  ## Convert to One-hot
test_X_ = W2V.Convert2Vec("./model/Word2vec.model",test_X)  ## import word2vec model where you have trained before
...
with tf.Session(config = config) as sess:
    ...
    for epoch in range(training_epochs):
        ...
        train_X_ = np.array(train_X_)[mask]
        train_Y_ = np.array(train_Y_)[mask]
